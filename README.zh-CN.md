...
- **2026 顶会时间线（Markdown）** — [可直接集成的 Markdown 文档](docs/2026-os-topconfs-timeline.zh-CN.md)。
- **作者与国家分析** — 研究方向分布与机构归属视图。

新员工可从 [OS 内核与系统顶会论文地图](docs/OS_TOP_CONFERENCE_PAPER_MAP.zh-CN.md) 入门：它按当前收录的会议、内核子系统与站内检索入口组织代表论文和 12 周阅读路线。
